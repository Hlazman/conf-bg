...
const ParquetSelection = ({ suborderId, brand, onAfterSubmit }) => {
  ...
  const items = [
    ...
    },
    {
      ...
      children: (
        <Card>
          {/* Row 1: grade, variants, color title */}
          <Row gutter={[12, 12]} style={{ marginBottom: 24 }}>
            <Col span={8}>
              ...
              >
                ...
                //   <Option key={pg.documentId} value={pg.documentId}>{pg.title}</Option>
                  <Option key={pg.documentId} value={pg.documentId}>{translations[pg.title]}</Option>
                ))}
              </Select>
            </Col>
            <Col span={8}>
              ...
              >
                ...
                //   <Option key={v} value={v}>{v}</Option>
                  <Option key={v} value={v}>{translations[v]}</Option>
                ))}
              </Select>
            </Col>
            <Col span={8}>
              ...
              <Input
                ...
                // placeholder={parquetColoringVariants === 'standard' ? 'Введите название цвета' : 'Доступно при выборе standard'}
              />
            </Col>
          </Row>
