...
// MAIN
  ...
  errAlertSliding: "The sliding system does not fit this door leaf.",
  ...
  "Insert for skirting (2050 mm)": "Insert for skirting (2050mm)",
  "Insert for skirting (2750 mm)": "Insert for skirting (2750mm)",
  "Skirting Aluminium": "Skirting Aluminium",
  "Skirting MDF Radius (2050 mm)": "Skirting MDF Radius (2050mm)",
  "Skirting MDF Radius (2750 mm)": "Skirting MDF Radius (2750mm)",
  "Skirting MDF (2050 mm)": "Skirting MDF (2050mm)",
  "Skirting MDF (2750 mm)": "Skirting MDF (2750mm)",
  ...
  "With running rail aluminum without coating 2200 mm and lower support guide 2200 mm": "With running rail aluminum without coating 1100 mm and lower support guide 2200 mm",
  ...
  "Oak Deck": 'Paluba (Oak)',
  "Oak English Herringbone": 'English Herringbone (Oak)',
  "Oak French Herringbone": 'French Herringbone (Oak)',
  "Oak Riga Herringbone": 'Riga Herringbone (Oak)',
  "Oak Mansion Weave": 'Mansion Weave (Oak)',
  "Oak Semi Hexagon": 'Semi Hexagon (Oak)',
  "Oak Hexagon": 'Hexagon (Oak)',
  "Oak Hexagon And Chevron": 'Hexagon And Chevron (Oak)',
  "Thermal Ash Deck": 'Paluba (Thermal Ash)',
  "Red Oak Deck": 'Paluba (Red Oak)',
  "Red Oak English Herringbone": 'English Herringbone (Red Oak)',
  "Red Oak French Herringbone": 'French Herringbone (Red Oak)',
  "Walnut Deck": 'Paluba (Walnut)',
  "Walnut English Herringbone": 'English Herringbone (Walnut)',
  "Walnut French Herringbone": 'French Herringbone (Walnut)',
  "Walnut Riga Herringbone": 'Riga Herringbone (Walnut)',
  "Ash Deck": 'Paluba (Ash)',
  "Ash English Herringbone": 'English Herringbone (Ash)',
  "Ash French Herringbone": 'French Herringbone (Ash)',
  "Ash Riga Herringbone": 'Riga Herringbone (Ash)',
  "American Walnut French Herringbone": 'French Herringbone (American Walnut)',
  "American Walnut English Herringbone": 'English Herringbone (American Walnut)',
  "American Walnut Deck": 'Paluba (American Walnut)',
  'Arhidona': 'Arhidona (Oak)',
  'Favorite': 'Favorite (Oak)',
  'Derbi': 'Derbi (Oak)',
  'Versal Big': 'Versal Big (Oak)',
  'Traversyn New': 'Traversyn New (Oak)',
  'Catalog': 'Catalog (Oak)',
  'Rhomb New': 'Rhomb New (Oak)',
  'Rhomb Nut': 'Rhomb Nut (Walnut)',
  'Star': 'Star (Oak)',
  'Traversyn': 'Traversyn (Oak)',
  'Derbi NEW': 'Derbi NEW (Oak)',
  'Brentwood': 'Brentwood (Oak)',
};
